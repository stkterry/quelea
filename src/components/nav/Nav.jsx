    ...
    return (
      <div id="nav" className="vert-grad">
        <div className="nav-sitename">
          ...
          <a className="nav-boidslink btn-raise" href="https://www.red3d.com/cwr/boids/" target="_blank">A Boids Simulation</a>
        </div>
        ...
        <div className="nav-links">
          ...
          <div className="nav-text-divider"></div>
          <a href="https://github.com/stkterry/quelea" className="btn-raise" target="_blank"><i className='fab fa-github-square' /></a>
